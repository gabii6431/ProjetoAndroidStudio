...
public class Modulos_Dificil extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valorProgressBar1 = preferencia.getInt("progressMod1_Dificil", 0);
        valorProgressBar2 = preferencia.getInt("progressMod2_Dificil", 0);
        valorProgressBar3 = preferencia.getInt("progressMod3_Dificil", 0);

        Log.d("Tag", "valorProgressBar1 Dificil: " + valorProgressBar1);
        Log.d("Tag", "valorProgressBar2 Dificil: " + valorProgressBar2);
        Log.d("Tag", "valorProgressBar3 Dificil: " + valorProgressBar3);
    ...
    public void onClick(View v) {
        if (v == btnJogar){
            ...
            escritor.commit();
            Log.d("Tag", "Modulo Dificil:" + modulo);
