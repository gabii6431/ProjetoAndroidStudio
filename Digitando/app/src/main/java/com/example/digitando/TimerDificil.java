...
public class TimerDificil extends CountDownTimer{
    private Context context;
    private TextView tv;
    private long timeInFuture;

    public TimerDificil(Context context, TextView tv, long timeInFuture,long interval){
    ...
    public void onFinish() {
        ...
        Intent i = new Intent(context,TempoEsgotadoDificil.class);
